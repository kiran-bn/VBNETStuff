...
Public Class Table1_add
    Dim cn As New OleDbConnection
    Dim cmd As New OleDbCommand
    Private Sub aio_add_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If txt_name.Text <> "" Then
            ...
            Try
                ...
                With cmd
                    .Connection = cn
                    .CommandText = "INSERT INTO aio_table(Name,FatherName,Mobile,Telephone,Gender,Email,DateOfBirth,Batch,Sess,City,Picture) VALUES(@a0,@a1,@a2,@a3,@a4,@a5,@a6,@a7,@a8,@a9,@a10)"
                    ...
                    Table1.Aio_tableTableAdapter.FillByName(Table1.Data_aioDataSet.aio_table, "")
                    '//
                    '//
                    '// Refresh total records label
                    Table1.lbl_total_records.Text = Table1.Data_aioDataSet.aio_table.Rows.Count
