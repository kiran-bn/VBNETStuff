...
Public Class Table2_add
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If txt_name.Text <> "" Then
            ...
            Try
                ...
                With cmd
                    .Connection = cn
                    .CommandText = "INSERT INTO mc_table(Name,FatherName,Mobile,Telephone,Gender,Email,DateOfBirth,Batch,Sess,City,Picture) VALUES(@a0,@a1,@a2,@a3,@a4,@a5,@a6,@a7,@a8,@a9,@a10)"
                    ...
                    Table2.Mc_tableTableAdapter.FillByName(Table2.Data_aioDataSet.mc_table, "")
                    '//
                    '//
                    '//
                    '//REFRESH TATAL RECORDS LABEL
                    Table2.lbl_total_records.Text = Table2.Data_aioDataSet.mc_table.Rows.Count
                End With
            Catch ex As Exception
                MsgBox(ex.Message)
            End Try
    ...
    Private Sub mc_add_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
