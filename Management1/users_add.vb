...
Public Class users_add
            ...
            If TextBox3.Text <> "" Then
                ...
                If TextBox4.Text <> "" Then
                    ...
                    If TextBox4.Text = TextBox5.Text Then
                        ...
                        With cmd
                            .Connection = cn
                            .CommandText = "INSERT INTO users_data(Name,Email,Gender,Username,Pass) VALUES(@a0,@a1,@a2,@a3,@a4)"
                            ...
                            Try
                                ...
                                users.Users_dataTableAdapter.update_users(users.Data_aioDataSet.users_data, "")
                                ''
                                ''
                                'This line will update total users count
                                users.Label7.Text = users.Data_aioDataSet.users_data.Rows.Count
    ...
    Private Sub users_add_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim str As String
